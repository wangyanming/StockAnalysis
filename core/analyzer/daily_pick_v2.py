...
def format_v2_report(results: dict) -> str:
    ...
    lines.append("")
    lines.append("📝 **评分说明**: 筹码结构(25分)+资金接力(25分)+板块环境(12分)+趋势位置(14分)+大盘安全(10分)+位置评分(+15分)")   # 2026-08-19：板块 20→12
    lines.append("")
    ...
    def _format_stock(r, num, group_label):
        ...
        dims = [('筹码结构', '筹码', 25), ('资金接力', '接力', 25), ('板块环境', '板块', 12), ('趋势位置', '趋势', 14), ('大盘安全', '大盘', 10)]
